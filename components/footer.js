      ...
      <footer className="footer section-container">
        <div className="max-width max-content-container">
          <div className="container">
            <img
              alt="image"
              src="/playground_assets/tech%20logo.svg"
              className="image"
            />
            <span className="text content-Light">
              The trust that our clients put is in us is something we never take
              for granted. Providing Best-in-Class managed IT services and
              investing in our own infrastructure to support our client needs.
              <span
            ...
            <div className="social-media">
              <span className="text01">Follow us</span>
              <div className="container1">
                <svg viewBox="0 0 602.2582857142856 1024" className="icon">
          ...
          <div className="links">
            <div className="container2">
              <span className="text02">Site Map</span>
              <span className="footer-link">Home</span>
              <span className="footer-link">Digital Marketing</span>
              <span className="footer-link">Computer Repair Services</span>
              <span className="footer-link">Shop</span>
              <span className="text07 footer-link">Cart</span>
            </div>
            <div className="container3">
              <span className="text08">Other</span>
              <span className="footer-link">Contact Us</span>
              <span className="footer-link">About us</span>
              <span className="footer-link">Privacy Policy</span>
              <span className="footer-link">Terms and Conditions</span>
              <span className="text13 footer-link">Refund Policy</span>
            </div>
          </div>
        </div>
      </footer>
