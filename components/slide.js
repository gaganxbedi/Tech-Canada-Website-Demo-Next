...
const Slide = (props) => {
  return (
    <>
      <div data-type="slide" className={`slide ${props.rootClassName} `}>
          ...
          <div className="left-side">
            ...
            <div className="image-container">
              ...
              <div className="slider-controls">
                <div data-action="previousSlide" className="go-left">
                  <svg viewBox="0 0 1024 1024" className="icon">
                    <path d="M854 470v84h-520l238 240-60 60-342-342 342-342 60 60-238 240h520z"></path>
                  </svg>
                </div>
                <div data-action="nextSlide" className="go-right">
...
Slide.defaultProps = {
  ...
  Testimonial:
    'âLove it! I really like the user interface. The sleek aesthetic of the software makes it easy and pleasant to use. I am also a big fan of the way I can customize and organize different feeds and mail sources.â',
  rootClassName: '',
  image_src:
